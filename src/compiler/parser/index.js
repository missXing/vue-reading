  ...
  function closeElement (element) {
    ...
    if (currentParent && !element.forbidden) {
      if (element.elseif || element.else) {
        ...
        // 而是存到父 AST 元素节点的 scopedSlots 属性上，它是一个对象，以插槽名称 name 为 key
...
function processSlotContent (el) {
  ...
  // slot="xxx"
  // 给对应的 AST 元素节点添加 slotTarget 属性
  // 在 codegen 阶段，在 genData 中会处理 slotTarget
